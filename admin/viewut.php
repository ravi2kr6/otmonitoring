<?php
	...
	$rs1=mysql_query("select * from etest.add order by aid asc");
...
<div class="col-md-1 col-md-offset-11">
	<a href="adduser.php"><i class="fa fa-user-plus"></i></a>
	 ...
	 <td><?php echo $r1['aid']; ?></td>
	 <td><?php echo $r1['username']; ?></td>
	 <td>&nbsp;<a href="deleteut.php?id=<?php echo $r1['aid']; ?>"><i class="fa fa-trash-o"></i>&nbsp;</a></td>
