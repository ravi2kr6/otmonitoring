<?php
	...
	mysql_query("insert into etest.add set username='$username',password='$key'");
...
Add User
 ...
 <label class="col-md-4 control-label" for="exampleInputEmail">Username</label>
 <div class="col-md-8">
 ...
 <br>
  <div class="form-group">
 <label class="col-md-4 control-label" for="exampleInputEmail">Key:</label>
 <div class="col-md-8">
 <input type="text" class="form-control" placeholder="Enter User Identification Key" name="key"> 
 </div>
 </div>
  <br>
 <br>
