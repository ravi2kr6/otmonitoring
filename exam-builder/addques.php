<?php
	...
	mysql_query("insert into questions set sub_id='$category',question='$question',ans1='$ans1',ans2='$ans2',ans3='$ans3',ans4='$ans4',ans='$ans'");
...
Add Your Question Here
 ...
 <textarea id="mytextarea" class="form-control" placeholder="Add Your Question Here" name="question"> </textarea>
 </div>
   <br>
 <br>
 </div>
 ...
 <div class="col-md-8">
 <input type="text" class="form-control" placeholder="Add Option 1" name="ans1"> 
 </div>
 </div>
  <br>
 ...
 <div class="col-md-8">
 <input type="text" class="form-control" placeholder="Add Option 2" name="ans2"> 
 </div>
 </div>
  <br>
 <br>
 ...
 <div class="col-md-8">
 <input type="text" class="form-control" placeholder="Add Option 3" name="ans3"> 
 </div>
 </div>
  <br>
 <br>
 ...
 <div class="col-md-8">
 <input type="text" class="form-control" placeholder="Add Option 4" name="ans4"> 
 </div>
 </div>
  <br>
 <br>
 ...
 <div class="col-md-8">
 <input type="text" class="form-control" placeholder="Enter Complete Answer" name="ans"> 
 </div>
 </div>
  <br>
 <br>
