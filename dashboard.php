...
<br>
<br>
<h1>Welcome,<small><em><?php echo $r['name']; ?></em></small></h1>
<i class="fa fa-envelope-square"></i>&nbsp;&nbsp;E-Mail :<?php echo $r['email']; ?> <br>
<i class="fa fa-at"></i>&nbsp;&nbsp;Username :<?php echo $r['username']; ?><br> 
<i class="fa fa-globe"></i>&nbsp;&nbsp;Country :<?php echo $r['country']; ?> <br>
<i class="fa fa-user"></i>&nbsp;&nbsp;Gender :<?php echo $r['gender']; ?> <br>
<i class="fa fa-birthday-cake"></i>&nbsp;&nbsp;Birthday :<?php echo $r['birthday']; ?> <br>
</div>
</div>
<div class="col-xs-6 col-sm-4">
<div class="container-fluid">
<br>
<br>
<img src="<?php echo $r['avatar']; ?>" alt="avatar" class="img-thumbnail img-responsive" align="right">
</div>   
</div>
</div>
</div>
